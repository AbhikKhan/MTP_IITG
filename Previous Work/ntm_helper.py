...
#     edgesCollection = nx.draw_networkx_edges(H, pos, edgelist=edgelist, width=1, arrows=True)
	edgesCollection = nx.draw_networkx_nodes(H, pos, nodelist=horizontalEdges, node_size=400, node_color='darkgreen',
...
#     edgesCollection = nx.draw_networkx_edges(H, pos, edgelist=edgelist, width=1, arrows=True)
	edgesCollection = nx.draw_networkx_nodes(H, pos, nodelist=verticalEdges, node_size=400, node_color='darkgreen',
											 node_shape=v, alpha=0.40, linewidths=2, label='Valve')
