...
s = Optimize()
X1, Y1 = Reals('X1 Y1')
x1, y1, s1 = Ints('x1 y1 s1')
X2, Y2 = Reals('X2 Y2')
x2, y2, s2 = Ints('x2 y2 s2')
X3, Y3 = Reals('X3 Y3')
x3, y3, s3 = Ints('x3 y3 s3')
X4, Y4 = Reals('X4 Y4')
x4, y4, s4 = Ints('x4 y4 s4')
w21 = Int('w21')
...
t7, t8, t9 = Reals('t7 t8 t9')
s.add(y1 + t7 + t8 + t9 == 4*Y1)
...
t10, t11 = Reals('t10 t11')
s.add(y2 + t10 + t11 == 4*Y2)
...
s.add(s1 == s2 + w31 + w41 )
s.add(s1 <= 8)
s.add(And(X1 == (1.0*199)/256, Y1 == (1.0*57)/256))
